...
export function NotResults({ addCallback }) {
    ...
    return (
        <Flex minH="200px" direction="column" alignItems="center" justifyContent="center" mb={20} p={4}>
            <Image w={400} src={ImageNotResults} alt="Logo" />
            <Flex direction="column" alignItems="center" justifyContent="center" maxW="600px">
                <Text textAlign="center" fontSize="2xl" fontWeight="bold" color="black">Oops, parece que los resultados se han esfumado en una expedición espacial</Text>
                <Text mt={3} textAlign="center" fontSize="lg" fontWeight="light" color="black">Si quieres llenar de vida este universo vacío, ¡simplemente pulsa el botón de añadir!</Text>
